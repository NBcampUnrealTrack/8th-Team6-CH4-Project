# Resume HUD WBP build from partial WBP_GameHUD (after AddWidgetTool fix)
param(
...
if (-not (Wait-McpServer)) { throw "MCP server not reachable at $BaseUrl" }
...
Write-Host "HUD MCP resume finished."
